...
plot_S5<-ggplot(comp_flux_m, aes(variable, value))+ # Fig S5 supp material
  ylab(expression(paste("OC Seq. Rate (kg"," ", m^-2,yr^-1, ")")))+ xlab("Time frame")+
...
grid.arrange(arrangeGrob(BSmp,top="Tidal Marsh", left=textGrob("Above Biomass Stock",rot = 90,gp=gpar(fontsize=15))),arrangeGrob(BSgp, top="Seagrass"),
...
# Figure 1
final<-grid.arrange(arrangeGrob(BSmp,top="Tidal Marsh", left=textGrob("Above Biomass Stock",rot = 90,gp=gpar(fontsize=15))),arrangeGrob(BSgp, top="Seagrass"),
               arrangeGrob(SSmp, left=textGrob("OC Soil Stock",rot = 90,gp=gpar(fontsize=15))),SSgp,
               arrangeGrob(FSmp, left=textGrob("OC Sequestration Rate",rot = 90, gp=gpar(fontsize=15))),FSgp,
               ncol=2, nrow=3,
               widths = c(1,0.9))
